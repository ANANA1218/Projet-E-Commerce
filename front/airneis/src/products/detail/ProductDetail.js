import Image from "../../assets/img/products/hauga.jpg";
            ...
            <div className="row mb-4">
                ...
                <div className="col-lg-5">
                    <div className="d-flex flex-column h-100">
                        ...
                        <hr />
                        <dl className="row">
                            <Detail name={"Code"} content={"C0001"} />
                            <Detail name={"Category"} content={"Cases & Covers"} />
                            <Detail name={"Brand"} content={"iPhone X"} />
                            <Detail name={"Manufacturer"} content={"Nillkin"} />
                            <Detail name={"Color"} content={"Red, Green, Blue, Pink"} />
                            <Detail name={"Status"} content={"Instock"} />
                            <Detail name={"Rating"} content={<Ratings
                                rating={4.5}
