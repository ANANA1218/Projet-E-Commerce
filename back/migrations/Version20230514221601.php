...
final class Version20230514221601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id_commande INT AUTO_INCREMENT NOT NULL, id_reduction INT NOT NULL, id_utilisateur INT NOT NULL, date_commande DATE NOT NULL, statut ENUM(\'en attente de confirmation\',\'en cours\',\'expedie\',\'livre\',\'annule\',\'retour\') COMMENT \'(DC2Type:statut_enum)\' NOT NULL, prix_total DOUBLE PRECISION NOT NULL, INDEX IDX_6EEAA67D31D2E84F (id_reduction), INDEX IDX_6EEAA67D50EAE44 (id_utilisateur), PRIMARY KEY(id_commande)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
